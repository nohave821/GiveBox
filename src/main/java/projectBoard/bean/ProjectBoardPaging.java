...
public class ProjectBoardPaging {
	...
	public ProjectBoardPaging(){}
	
	public ProjectBoardPaging(int currentPage, int pageBlock, int pageSize) {
	...
	public void makePagingHTML(){
		...
		int totalA=ProjectBoardService.getProjectTotalArticle();//총글수	
